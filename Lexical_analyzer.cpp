...
static int Compare_KeyWords (const char* string__, size_t num_symbols)
{
    ...
    static Key_word KeyWords [] = {
        {"Èñòîðèÿ_îõîòû_îäíîãî_êðîìàíüîíöà_íà_ÌÀÌÎÍÒÀ!", BEGINING, 44},
        {"ÓÓÓÀÀÀ_ß_ÕÀÒÅÒÜ_ÂÛÉÒÈ_ÈÇ_ÏÈÙÅÐÀ", OPENING_CURLY_BRACKET, 31},
        {"ÐÀÀÀÀÀÀÀÐÐÐÐ_åäà_êëàñòü_â_ðîò" , CLOSING_CURLY_BRACKET, 29},
        {"çàëåçàòü_íà_äåðåâî", OPENING_BRACKET, 18},
        {"ñëåçàòü_ñ_äåðåâî", CLOSING_BRACKET, 16},
        {"õàòåòü_÷òîáû_áûòü", DECLARATION_ID, 17},
        {"=", EQUALS, 1},
        {"çàëåçòü_íà_ÌÀÌÎÍÒÀ", DECLARATION_FUNCTION, 18},
        {"ÕÀÒÅÒÜ ÊÀÊÀÒÜ ÍÎ", IF, 16},
        {"ñëåäèòü_çà_äîáû÷à_íÿì_íÿì", WHILE, 25},
        {"sin", SIN, 3},
        {"cos", COS, 3},
        {"Îõîòà_çàêîí÷åíà_!", ENDING, 17},
        {"âçÿòü", PRE_EQUAL, 5},
        {"è_ïàëàæèòü_â", IN_EQUAL, 12},
        {"äàáàâèòü", ADDITTION, 8},
        {"ïîïðîáîâàòü", SUBTRACTION, 11},
        {"ïîíþõàòü", DIVISION, 8},
        {"ïîòðîãàòü", MULTIPLICATION, 9},
        {"ÑËÎÆÍÀÀÀ", ELEVATION, 8},
        {"ÃÝÝ", SEPARATOR, 3},
        {"ñúåë", EQUAL_COMPARE, 4},
        {"êóñàòü", NOT_EQUALE_COMPARE, 6},
        {"ìàëî", LESS, 4},
        {"ñëîìàòü", LESS_OR_EQUALE, 7},
        {"ÃÓÀÀÀ", MORE, 5},
        {"ÝÝÛÛÛÛ", MORE_OR_EQUAL, 6},
        {"ÓÝÝÝÝÝ", BEGIN_PARAM_FUNC,6},
        {"ÀÚÚÚ", END_PARAM_FUNC, 4},
...
{
    if (symbol >= 'À' && symbol <= 'ÿ')  // çíàêè íàîáîðîò ò.ê. ìèíóñ
        return 1;
